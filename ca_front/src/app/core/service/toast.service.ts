...
export class ToastService implements OnDestroy {
   ...
   */
  warning(message: string, params?: any, options?: OptionToast) {
   ...
   * @param options les options du toast.
   */
  info(message: string, params?: any, options?: OptionToast) {
   ...
   * @param options les options du toast.
   */
  success(message: string, params?: any, options?: OptionToast) {
   ...
   * @param options les options du toast.
   */
  error(message: string, params?: any, options?: OptionToast) {
    this.toast(ToastLevelEnum.ERROR, message, params, options);
  }

  traiterParams(message, params?: any): string {
  ...
  private toast(level: ToastLevelEnum, message: string, params?: any, options?: OptionToast) {
