package fr.sigma.ca.web.rest.errors;

import fr.sigma.ca.service.core.UsernameAlreadyUsedException;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
        fr.sigma.ca.service.core.EmailAlreadyUsedException ex, NativeWebRequest request) {
    ...
    public ResponseEntity<Problem> handleInvalidPasswordException(
        fr.sigma.ca.service.core.InvalidPasswordException ex, NativeWebRequest request) {
