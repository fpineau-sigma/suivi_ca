...
@NgModule({
  ...
  declarations: [FindLanguageFromKeyPipe, AlertComponent, AlertErrorComponent, LoginModalComponent, ToastComponent, HasAnyAuthorityDirective, PersonneComponent, AdresseComponent],
