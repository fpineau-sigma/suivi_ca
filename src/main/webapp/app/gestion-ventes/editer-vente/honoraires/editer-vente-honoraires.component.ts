...
export class EditerVenteHonorairesComponent implements OnInit, OnDestroy {
  ...
  constructor(private venteForm: FormGroupDirective,
  ...
  ngOnInit(): void {
    ...
    this.venteHonorairesForm.addControl('_honoraires', this.formBuilder.group({
      venteDateVenteCompromis: ['', Validators.required],
