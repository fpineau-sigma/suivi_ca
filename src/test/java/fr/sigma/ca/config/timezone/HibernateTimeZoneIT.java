package fr.sigma.ca.config.timezone;

import fr.sigma.ca.CaClemenceApp;
import fr.sigma.ca.repository.timezone.DateTimeWrapper;
import fr.sigma.ca.repository.timezone.DateTimeWrapperRepository;
